...
export const apiServiceAxios = {
    // GET запрос
    get: (url, config = {}, authRequired = true) => {
        return api.get(url, { ...config, authRequired });
    },

    // POST запрос
    post: (url, data, config = {}, authRequired = true) => {
        return api.post(url, data, { ...config, authRequired });
    },

    // PUT запрос
    put: (url, data, config = {}, authRequired = true) => {
        return api.put(url, data, { ...config, authRequired });
    },

    // DELETE запрос
    delete: (url, config = {}, authRequired = true) => {
        return api.delete(url, { ...config, authRequired });
    },

    // PATCH запрос
    patch: (url, data, config = {}, authRequired = true) => {
        return api.patch(url, data, { ...config, authRequired });
    },

    // Для загрузки файлов (FormData)
    upload: (url, formData, config = {}, authRequired = true) => {
